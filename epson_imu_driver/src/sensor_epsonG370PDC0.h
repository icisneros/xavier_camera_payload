//==============================================================================
//
// 	sensor_epsonG370PDC0.h - Epson G370PDC0 sensor specific definitions
//
//
...
//
//==============================================================================
#ifndef EPSONG370PDC0_H_
#define EPSONG370PDC0_H_
...
#define ADDR_LPF_CTRL_LO           0x18     // LPF_CTRL Byte0 (W1)
#define ADDR_LPF_CTRL_HI           0x19     // LPF_CTRL Byte1 (W1)
...
// Write values for LPF_CTRL_LO to set GYRO_LPF_FC
#define CMD_GYRO_LPF9_4HZ          0x01
#define CMD_GYRO_LPF23_6HZ         0x02
#define CMD_GYRO_LPF47_2HZ         0x03
#define CMD_GYRO_LPF94_4HZ         0x04
#define CMD_GYRO_LPF189HZ          0x05

// Write values for LPF_CTRL_HI to set ACCL_LPF_FC
#define CMD_ACCL_LPF1_7HZ          0x00
#define CMD_ACCL_LPF16_7HZ         0x01
#define CMD_ACCL_LPF167HZ          0x02

// MODE STAT
#define VAL_SAMPLING_MODE          0x00
#define VAL_CONFIG_MODE            0x04

#endif /* EPSONG370PDC0_H_ */
